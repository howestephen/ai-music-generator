...
created: 2026-09-25
updated: 2026-09-25
source: Stability AI, stable-audio-3 docs/guides/prompting.md
---

Copied from the local Stable Audio 3 clone. Dashes in the original were
rewritten as spaced hyphens so this repo can store the guide. The figure
it references is not included. Wording below is theirs.
...
The original guide shows a screenshot of the Gradio prompt assistant here. That image is not in this copy.
